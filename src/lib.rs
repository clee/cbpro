...
//! ## cbpro
//!
//! This crate provides an easy to use API interface for interacting with [https://docs.pro.coinbase.com](https://docs.pro.coinbase.com).
//! For private endpoints to Coinbase Pro use [AuthenticatedClient](client/struct.AuthenticatedClient.html). For public endpoints use [PublicClient](client/struct.PublicClient.html) or [AuthenticatedClient::public](client/struct.AuthenticatedClient.html#method.public).
